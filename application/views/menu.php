			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<!-- <li class="nav-item cta">
						<a href="<?= base_url() ?>" class="nav-link md-5"
							style="border-radius: 25px; margin-right:10px;">Tambah Meja</a>
					</li> -->
					<li class="nav-item cta">
            <a href="<?= base_url('auth/login') ?>" class="btn btn-primary" style="padding: 15px 30px; font-size: 16px;">Log-in</a>
        </li>
  ...
  <div class="container">
    ...
    <div class="row no-gutters d-flex align-items-stretch">
      <?php foreach ($konten as $uu) { ?>
        ...
        <div class="col-md-12 col-lg-6 d-flex align-self-stretch" style="padding:20px; width:100;">
          <div class="menus d-sm-flex ftco-animate align-items-stretch">
            ...
            <div class="text d-flex align-items-center">
              <div>
                <div class="d-flex">
                  <div class="one-half">
                    <span class="subheading" style="font-size: 1.5rem; font-weight: bold;"><?= $uu['judul'] ?></span>
                  </div>
                  <div class="one-forth">
                    <span class="price">Rp.<?= $uu['Harga'] ?>K</span>
                  </div>
                </div>
                
                <a href="<?= base_url('home/artikel/' . $uu['slug']) ?>" class="btn btn-primary">Detail</a>
              </div>
            </div>
          </div>
        </div>
